...
HD_PWD='C:/Users/Sebastien Danthinne/Documents/Documents/vivadoProjects/finalProject/finalProject.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log connector.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source connector.tcl
